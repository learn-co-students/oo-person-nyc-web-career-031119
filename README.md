...
## Instructions
- First you need to create a person class that is initialized with a name that cannot be changed. #CONSTANTS
- Each instance of class `Person`should be able to remember their name #SETTER
- Each instance of  class `Person` should start with $25 in their bank accounts #initialize
